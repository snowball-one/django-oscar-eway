...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('eway_transaction', 'status',
                      self.gf('django.db.models.fields.CharField')(default=u'in progress', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.status'
        db.delete_column('eway_transaction', 'status')
    ...
    models = {
        ...
        'eway.requestlog': {
            ...
            'transaction': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'request_logs'", 'to': "orm['eway.Transaction']"}),
        ...
        'eway.transaction': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "u'in progress'", 'max_length': '255'}),
